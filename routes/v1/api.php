...
use App\Http\Controllers\v1\Auth\SendOTPController;
...
Route::post('/register/sendotp', [SendOTPController::class, 'sendOTPToPhone']);
Route::post('/register/verify_otp', [SendOTPController::class, 'verifyRegistrationOTP']);
